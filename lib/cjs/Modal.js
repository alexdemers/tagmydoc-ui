...
const ModalHeaderOnlyTitle = ({ className = '', icon = null, children }) => {
    return (jsx_runtime_1.jsx(exports.ModalHeader, Object.assign({ className: className }, { children: jsx_runtime_1.jsxs("h3", Object.assign({ className: "text-lg font-medium text-gray-900" }, { children: [icon !== null && jsx_runtime_1.jsx(react_fontawesome_1.FontAwesomeIcon, { icon: icon, className: "mr-2 text-gray-400" }, void 0),
