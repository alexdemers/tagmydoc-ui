...
const Badge = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Tag, Object.assign({ className: `whitespace-nowrap px-2 inline-flex font-semibold text-xs hover:transition-colors focus:ring ease-in-out duration-100 rounded-full ${disabled} ${props.onClick ? active : ''} ${props.onClick ? hover : ''} ${className}` }, props), void 0));
};
