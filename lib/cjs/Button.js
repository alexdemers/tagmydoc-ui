...
const ButtonRenderFunction = (props, ref) => {
    return jsx_runtime_1.jsx("button", Object.assign({}, props, { ref: ref, className: exports.resolveClassName(props) }), void 0);
};
...
const Button = react_1.forwardRef(ButtonRenderFunction);
