...
const InputRenderFunction = (_a, ref) => {
    ...
    if (icon !== null) {
        return (_jsxs("div", Object.assign({ className: `relative items-center ${block ? 'flex w-full' : 'inline-flex'}` }, { children: [child,
                typeof icon === 'string' ? _jsx(FontAwesomeIcon, { icon: icon, className: `absolute ${iconColor} left-4` }, void 0) : icon] }), void 0));
    }
    return child;
};
...
const CheckboxRenderFunction = (_a, ref) => {
    ...
    const id = ID();
    return (_jsxs("label", Object.assign({ className: `flex items-center ${className}`, htmlFor: id }, { children: [_jsx("input", Object.assign({ ref: ref, type: "checkbox", id: id, className: `${InputClassNames} ${children !== undefined ? 'mr-2' : ''}` }, props), void 0),
            children] }), void 0));
};
