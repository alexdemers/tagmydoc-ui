...
const InputGroupRenderFunction = (_a, ref) => {
    ...
    return (_jsxs("div", Object.assign({ className: "relative w-full" }, { children: [_jsx(InputBlock, Object.assign({ ref: ref }, inputProps), void 0), prepended !== null && _jsx("div", Object.assign({ className: "absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none" }, { children: prepended }), void 0), appended !== null && _jsx("div", Object.assign({ className: `absolute inset-y-0 right-0 flex items-center ${inputProps.type === 'number' ? 'pr-10' : 'pr-3'} pointer-events-none` }, { children: appended }), void 0)] }), void 0));
};
...
export const InputDateTime = (_a) => {
    ...
    return (_jsxs("span", Object.assign({ className: `inline-flex ${InputClassNames}` }, { children: [_jsx("input", { type: "date", className: "bg-transparent border-0 focus:ring-0", value: polyfillDateValue, onChange: dateOnChange }, void 0), _jsx("input", { type: "time", className: "bg-transparent border-0 focus:ring-0", value: polyfillTimeValue, onChange: timeOnChange }, void 0)] }), void 0));
};
