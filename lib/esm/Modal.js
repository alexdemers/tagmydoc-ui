...
export const ModalHeaderOnlyTitle = ({ className = '', icon = null, children }) => {
    return (_jsx(ModalHeader, Object.assign({ className: className }, { children: _jsxs("h3", Object.assign({ className: "text-lg font-medium text-gray-900" }, { children: [icon !== null && _jsx(FontAwesomeIcon, { icon: icon, className: "mr-2 text-gray-400" }, void 0),
