...
declare const resolveClassName: ({ disabled, circle, intent, variant, className, block, size, shadow, icon }: ButtonOptions) => string;
...
>;
declare const InputBlock: react.ForwardRefExoticComponent<
	Omit<InputHTMLAttributes<HTMLInputElement>, 'size'> & {
		icon?: IconProp | FontAwesomeIconProps | null | undefined;
		iconColor?: string | undefined;
		block?: boolean | undefined;
...
>;
declare const PasswordInputBlock: react.ForwardRefExoticComponent<
	Omit<InputHTMLAttributes<HTMLInputElement>, 'size'> & {
		icon?: IconProp | FontAwesomeIconProps | null | undefined;
		iconColor?: string | undefined;
		block?: boolean | undefined;
...
declare const ModalHeaderOnlyTitle: ({
	className,
	icon,
	children
}: react__default.PropsWithChildren<{
